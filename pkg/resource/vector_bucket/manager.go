...
// +kubebuilder:rbac:groups=s3vectors.services.k8s.aws,resources=vectorbuckets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=s3vectors.services.k8s.aws,resources=vectorbuckets/status,verbs=get;update;patch

var lateInitializeFieldNames = []string{"EncryptionConfiguration"}
