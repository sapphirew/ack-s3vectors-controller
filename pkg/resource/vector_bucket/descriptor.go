...
const (
	FinalizerString = "finalizers.s3vectors.services.k8s.aws/VectorBucket"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("vectorbuckets")
	GroupKind            = metav1.GroupKind{
		Group: "s3vectors.services.k8s.aws",
		Kind:  "VectorBucket",
	}
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.VectorBucket{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.VectorBucket),
	}
}
