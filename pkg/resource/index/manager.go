...
// +kubebuilder:rbac:groups=s3vectors.services.k8s.aws,resources=indices,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=s3vectors.services.k8s.aws,resources=indices/status,verbs=get;update;patch
