...
const (
	FinalizerString = "finalizers.s3vectors.services.k8s.aws/Index"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("indices")
